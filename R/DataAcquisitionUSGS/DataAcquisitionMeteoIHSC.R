...
# Save
write.csv(air_temp_daily, "Data/USGS/airtemp_ihsc.csv", row.names = FALSE)
...
# Save
write.csv(wind_speed_daily, "Data/USGS/windspeed_ihsc.csv",
          row.names = FALSE)
...
# Save
write.csv(wind_dir_daily, "Data/USGS/winddir_ihsc.csv", row.names = FALSE)
